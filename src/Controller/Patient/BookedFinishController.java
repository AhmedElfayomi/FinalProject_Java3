 ...
 * @author Ahmed
 */
public class BookedFinishController implements Initializable {
    ...
    @FXML
    private TableView<BookedAppointments> TableViewBookedF;
    @FXML
    ...
    @FXML
    private void showBookedF(ActionEvent event) {
        ...
        List<BookedAppointments> listUsers = em.createQuery(jpql).setParameter("status", "finished").setParameter("USERid", UserID.getId()).getResultList();
        TableViewBookedF.getItems().setAll(listUsers);
        em.close();
    }
